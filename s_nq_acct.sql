...
CREATE INDEX S_NQ_ACCT_M1 ON S_NQ_ACCT (START_DT, START_HOUR_MIN, USER_NAME);

CREATE INDEX S_NQ_ACCT_M2 ON S_NQ_ACCT (START_HOUR_MIN, USER_NAME);

CREATE INDEX S_NQ_ACCT_M3 ON S_NQ_ACCT (USER_NAME) ;
